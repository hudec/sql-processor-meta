 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoAnnotatedPropertyImpl#getSetterAnnotations <em>Setter Annotations</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoAnnotatedPropertyImpl#getGetterAnnotations <em>Getter Annotations</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoAnnotatedPropertyImpl#getAttributeAnnotations <em>Attribute Annotations</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoAnnotatedPropertyImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PojoAnnotatedPropertyImpl extends MinimalEObjectImpl.Container implements PojoAnnotatedProperty
{
  ...
  {
    return ProcessorMetaPackage.Literals.POJO_ANNOTATED_PROPERTY;
  }
  ...
  public EList<Annotation> getSetterAnnotations()
  {
    ...
    {
      setterAnnotations = new EObjectContainmentEList<Annotation>(Annotation.class, this, ProcessorMetaPackage.POJO_ANNOTATED_PROPERTY__SETTER_ANNOTATIONS);
    }
  ...
  public EList<Annotation> getGetterAnnotations()
  {
    ...
    {
      getterAnnotations = new EObjectContainmentEList<Annotation>(Annotation.class, this, ProcessorMetaPackage.POJO_ANNOTATED_PROPERTY__GETTER_ANNOTATIONS);
    }
  ...
  public EList<Annotation> getAttributeAnnotations()
  {
    ...
    {
      attributeAnnotations = new EObjectContainmentEList<Annotation>(Annotation.class, this, ProcessorMetaPackage.POJO_ANNOTATED_PROPERTY__ATTRIBUTE_ANNOTATIONS);
    }
  ...
  public NotificationChain basicSetFeature(PojoProperty newFeature, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_ANNOTATED_PROPERTY__FEATURE, oldFeature, newFeature);
  ...
  public void setFeature(PojoProperty newFeature)
  {
    if (newFeature != feature)
    {
      ...
      if (feature != null)
        msgs = ((InternalEObject)feature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJO_ANNOTATED_PROPERTY__FEATURE, null, msgs);
      if (newFeature != null)
        msgs = ((InternalEObject)newFeature).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessorMetaPackage.POJO_ANNOTATED_PROPERTY__FEATURE, null, msgs);
      msgs = basicSetFeature(newFeature, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_ANNOTATED_PROPERTY__FEATURE, newFeature, newFeature));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.POJO_ANNOTATED_PROPERTY__SETTER_ANNOTATIONS:
        return ((InternalEList<?>)getSetterAnnotations()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJO_ANNOTATED_PROPERTY__GETTER_ANNOTATIONS:
        return ((InternalEList<?>)getGetterAnnotations()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJO_ANNOTATED_PROPERTY__ATTRIBUTE_ANNOTATIONS:
        return ((InternalEList<?>)getAttributeAnnotations()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJO_ANNOTATED_PROPERTY__FEATURE:
