 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ImplementsImpl#getImplements <em>Implements</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ImplementsImpl#isGenerics <em>Generics</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ImplementsImpl#getOnlyPojos <em>Only Pojos</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ImplementsImpl#getOnlyDaos <em>Only Daos</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ImplementsImpl#getExceptPojos <em>Except Pojos</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ImplementsImpl#getExceptDaos <em>Except Daos</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImplementsImpl extends AbstractPojoEntityImpl implements Implements
{
  ...
  {
    return ProcessorMetaPackage.Literals.IMPLEMENTS;
  }
    ...
    if (implements_ != null && implements_.eIsProxy())
    {
      ...
      if (implements_ != oldImplements)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessorMetaPackage.IMPLEMENTS__IMPLEMENTS, oldImplements, implements_));
      }
    }
    return implements_;
  }
  ...
  public void setImplements(JvmType newImplements)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.IMPLEMENTS__IMPLEMENTS, oldImplements, implements_));
  }
  ...
  public void setGenerics(boolean newGenerics)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.IMPLEMENTS__GENERICS, oldGenerics, generics));
  }
  ...
  public EList<PojoEntity> getOnlyPojos()
  {
    if (onlyPojos == null)
    {
      onlyPojos = new EObjectResolvingEList<PojoEntity>(PojoEntity.class, this, ProcessorMetaPackage.IMPLEMENTS__ONLY_POJOS);
    }
    return onlyPojos;
  }
  ...
  public EList<PojoDao> getOnlyDaos()
  {
    if (onlyDaos == null)
    {
      onlyDaos = new EObjectResolvingEList<PojoDao>(PojoDao.class, this, ProcessorMetaPackage.IMPLEMENTS__ONLY_DAOS);
    }
    return onlyDaos;
  }
  ...
  public EList<PojoEntity> getExceptPojos()
  {
    if (exceptPojos == null)
    {
      exceptPojos = new EObjectResolvingEList<PojoEntity>(PojoEntity.class, this, ProcessorMetaPackage.IMPLEMENTS__EXCEPT_POJOS);
    }
    return exceptPojos;
  }
  ...
  public EList<PojoDao> getExceptDaos()
  {
    if (exceptDaos == null)
    {
      exceptDaos = new EObjectResolvingEList<PojoDao>(PojoDao.class, this, ProcessorMetaPackage.IMPLEMENTS__EXCEPT_DAOS);
    }
    return exceptDaos;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.IMPLEMENTS__IMPLEMENTS:
        if (resolve) return getImplements();
        return basicGetImplements();
      case ProcessorMetaPackage.IMPLEMENTS__GENERICS:
        return isGenerics();
      case ProcessorMetaPackage.IMPLEMENTS__ONLY_POJOS:
        return getOnlyPojos();
      case ProcessorMetaPackage.IMPLEMENTS__ONLY_DAOS:
        return getOnlyDaos();
      case ProcessorMetaPackage.IMPLEMENTS__EXCEPT_POJOS:
        return getExceptPojos();
      case ProcessorMetaPackage.IMPLEMENTS__EXCEPT_DAOS:
