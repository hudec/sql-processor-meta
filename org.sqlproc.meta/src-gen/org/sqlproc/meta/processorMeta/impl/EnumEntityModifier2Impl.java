 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.EnumEntityModifier2Impl#getSuperType <em>Super Type</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.EnumEntityModifier2Impl#getSernum <em>Sernum</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumEntityModifier2Impl extends MinimalEObjectImpl.Container implements EnumEntityModifier2
{
  ...
  {
    return ProcessorMetaPackage.Literals.ENUM_ENTITY_MODIFIER2;
  }
    ...
    if (superType != null && superType.eIsProxy())
    {
      ...
      if (superType != oldSuperType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessorMetaPackage.ENUM_ENTITY_MODIFIER2__SUPER_TYPE, oldSuperType, superType));
      }
    }
    return superType;
  }
  ...
  public void setSuperType(PojoEntity newSuperType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.ENUM_ENTITY_MODIFIER2__SUPER_TYPE, oldSuperType, superType));
  }
  ...
  public void setSernum(String newSernum)
  {
    ...
    sernum = newSernum;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.ENUM_ENTITY_MODIFIER2__SERNUM, oldSernum, sernum));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.ENUM_ENTITY_MODIFIER2__SUPER_TYPE:
        if (resolve) return getSuperType();
        return basicGetSuperType();
      case ProcessorMetaPackage.ENUM_ENTITY_MODIFIER2__SERNUM:
        return getSernum();
    }
