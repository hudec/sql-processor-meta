 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ExtendsImpl#getExtends <em>Extends</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ExtendsImpl#isGenerics <em>Generics</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ExtendsImpl#getOnlyPojos <em>Only Pojos</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ExtendsImpl#getOnlyDaos <em>Only Daos</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ExtendsImpl#getExceptPojos <em>Except Pojos</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.ExtendsImpl#getExceptDaos <em>Except Daos</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExtendsImpl extends AbstractPojoEntityImpl implements Extends
{
  ...
  {
    return ProcessorMetaPackage.Literals.EXTENDS;
  }
    ...
    if (extends_ != null && extends_.eIsProxy())
    {
      ...
      if (extends_ != oldExtends)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessorMetaPackage.EXTENDS__EXTENDS, oldExtends, extends_));
      }
    }
    return extends_;
  }
  ...
  public void setExtends(JvmType newExtends)
  {
    ...
    extends_ = newExtends;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.EXTENDS__EXTENDS, oldExtends, extends_));
  }
  ...
  public void setGenerics(boolean newGenerics)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.EXTENDS__GENERICS, oldGenerics, generics));
  }
  ...
  public EList<PojoEntity> getOnlyPojos()
  {
    if (onlyPojos == null)
    {
      onlyPojos = new EObjectResolvingEList<PojoEntity>(PojoEntity.class, this, ProcessorMetaPackage.EXTENDS__ONLY_POJOS);
    }
    return onlyPojos;
  }
  ...
  public EList<PojoDao> getOnlyDaos()
  {
    if (onlyDaos == null)
    {
      onlyDaos = new EObjectResolvingEList<PojoDao>(PojoDao.class, this, ProcessorMetaPackage.EXTENDS__ONLY_DAOS);
    }
    return onlyDaos;
  }
  ...
  public EList<PojoEntity> getExceptPojos()
  {
    if (exceptPojos == null)
    {
      exceptPojos = new EObjectResolvingEList<PojoEntity>(PojoEntity.class, this, ProcessorMetaPackage.EXTENDS__EXCEPT_POJOS);
    }
    return exceptPojos;
  }
  ...
  public EList<PojoDao> getExceptDaos()
  {
    if (exceptDaos == null)
    {
      exceptDaos = new EObjectResolvingEList<PojoDao>(PojoDao.class, this, ProcessorMetaPackage.EXTENDS__EXCEPT_DAOS);
    }
    return exceptDaos;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.EXTENDS__EXTENDS:
        if (resolve) return getExtends();
        return basicGetExtends();
      case ProcessorMetaPackage.EXTENDS__GENERICS:
        return isGenerics();
      case ProcessorMetaPackage.EXTENDS__ONLY_POJOS:
        return getOnlyPojos();
      case ProcessorMetaPackage.EXTENDS__ONLY_DAOS:
        return getOnlyDaos();
      case ProcessorMetaPackage.EXTENDS__EXCEPT_POJOS:
        return getExceptPojos();
      case ProcessorMetaPackage.EXTENDS__EXCEPT_DAOS:
