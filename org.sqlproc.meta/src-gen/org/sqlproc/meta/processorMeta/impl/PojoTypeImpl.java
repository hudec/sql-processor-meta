 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoTypeImpl#getNative <em>Native</em>}</li>
...
public class PojoTypeImpl extends MinimalEObjectImpl.Container implements PojoType
{
  ...
  public void setNative(String newNative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_TYPE__NATIVE, oldNative, native_));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.POJO_TYPE__NATIVE:
        return getNative();
