 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoDaoModifierImpl#getSuperType <em>Super Type</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoDaoModifierImpl#getSernum <em>Sernum</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PojoDaoModifierImpl extends MinimalEObjectImpl.Container implements PojoDaoModifier
{
  ...
  {
    return ProcessorMetaPackage.Literals.POJO_DAO_MODIFIER;
  }
    ...
    if (superType != null && superType.eIsProxy())
    {
      ...
      if (superType != oldSuperType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessorMetaPackage.POJO_DAO_MODIFIER__SUPER_TYPE, oldSuperType, superType));
      }
    }
    return superType;
  }
  ...
  public void setSuperType(PojoDao newSuperType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_DAO_MODIFIER__SUPER_TYPE, oldSuperType, superType));
  }
  ...
  public void setSernum(String newSernum)
  {
    ...
    sernum = newSernum;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_DAO_MODIFIER__SERNUM, oldSernum, sernum));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.POJO_DAO_MODIFIER__SUPER_TYPE:
        if (resolve) return getSuperType();
        return basicGetSuperType();
      case ProcessorMetaPackage.POJO_DAO_MODIFIER__SERNUM:
        return getSernum();
    }
