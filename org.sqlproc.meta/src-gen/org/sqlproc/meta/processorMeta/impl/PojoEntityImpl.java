 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoEntityImpl#getModifiers1 <em>Modifiers1</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoEntityImpl#getModifiers2 <em>Modifiers2</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoEntityImpl#getFeatures <em>Features</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PojoEntityImpl extends EntityImpl implements PojoEntity
{
  ...
  {
    return ProcessorMetaPackage.Literals.POJO_ENTITY;
  }
  ...
  public EList<PojoEntityModifier1> getModifiers1()
  {
    if (modifiers1 == null)
    {
      modifiers1 = new EObjectContainmentEList<PojoEntityModifier1>(PojoEntityModifier1.class, this, ProcessorMetaPackage.POJO_ENTITY__MODIFIERS1);
    }
    return modifiers1;
  }
  ...
  public EList<PojoEntityModifier2> getModifiers2()
  {
    if (modifiers2 == null)
    {
      modifiers2 = new EObjectContainmentEList<PojoEntityModifier2>(PojoEntityModifier2.class, this, ProcessorMetaPackage.POJO_ENTITY__MODIFIERS2);
    }
    return modifiers2;
  }
  ...
  public EList<PojoAnnotatedProperty> getFeatures()
  {
    if (features == null)
    {
      features = new EObjectContainmentEList<PojoAnnotatedProperty>(PojoAnnotatedProperty.class, this, ProcessorMetaPackage.POJO_ENTITY__FEATURES);
    }
    return features;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.POJO_ENTITY__MODIFIERS1:
        return ((InternalEList<?>)getModifiers1()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJO_ENTITY__MODIFIERS2:
        return ((InternalEList<?>)getModifiers2()).basicRemove(otherEnd, msgs);
      case ProcessorMetaPackage.POJO_ENTITY__FEATURES:
