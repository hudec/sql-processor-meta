 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoEntityModifier2Impl#getSuperType <em>Super Type</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoEntityModifier2Impl#getDiscriminator <em>Discriminator</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoEntityModifier2Impl#getOperators <em>Operators</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoEntityModifier2Impl#getOperatorsSuffix <em>Operators Suffix</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoEntityModifier2Impl#getSernum <em>Sernum</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PojoEntityModifier2Impl extends MinimalEObjectImpl.Container implements PojoEntityModifier2
{
  ...
  {
    return ProcessorMetaPackage.Literals.POJO_ENTITY_MODIFIER2;
  }
    ...
    if (superType != null && superType.eIsProxy())
    {
      ...
      if (superType != oldSuperType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessorMetaPackage.POJO_ENTITY_MODIFIER2__SUPER_TYPE, oldSuperType, superType));
      }
    }
    return superType;
  }
  ...
  public void setSuperType(PojoEntity newSuperType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_ENTITY_MODIFIER2__SUPER_TYPE, oldSuperType, superType));
  }
  ...
  public void setDiscriminator(String newDiscriminator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_ENTITY_MODIFIER2__DISCRIMINATOR, oldDiscriminator, discriminator));
  }
  ...
  public void setOperators(String newOperators)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_ENTITY_MODIFIER2__OPERATORS, oldOperators, operators));
  }
  ...
  public void setOperatorsSuffix(String newOperatorsSuffix)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_ENTITY_MODIFIER2__OPERATORS_SUFFIX, oldOperatorsSuffix, operatorsSuffix));
  }
  ...
  public void setSernum(String newSernum)
  {
    ...
    sernum = newSernum;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_ENTITY_MODIFIER2__SERNUM, oldSernum, sernum));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.POJO_ENTITY_MODIFIER2__SUPER_TYPE:
        if (resolve) return getSuperType();
        return basicGetSuperType();
      case ProcessorMetaPackage.POJO_ENTITY_MODIFIER2__DISCRIMINATOR:
        return getDiscriminator();
      case ProcessorMetaPackage.POJO_ENTITY_MODIFIER2__OPERATORS:
        return getOperators();
      case ProcessorMetaPackage.POJO_ENTITY_MODIFIER2__OPERATORS_SUFFIX:
        return getOperatorsSuffix();
      case ProcessorMetaPackage.POJO_ENTITY_MODIFIER2__SERNUM:
        return getSernum();
    }
