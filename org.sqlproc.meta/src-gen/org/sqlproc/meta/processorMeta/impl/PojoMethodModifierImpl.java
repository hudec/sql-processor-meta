 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoMethodModifierImpl#isCallFunction <em>Call Function</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoMethodModifierImpl#isCallUpdate <em>Call Update</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoMethodModifierImpl#isCallQuery <em>Call Query</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoMethodModifierImpl#isCallQueryFunction <em>Call Query Function</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.impl.PojoMethodModifierImpl#isCallSelectFunction <em>Call Select Function</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PojoMethodModifierImpl extends MinimalEObjectImpl.Container implements PojoMethodModifier
{
  ...
  {
    return ProcessorMetaPackage.Literals.POJO_METHOD_MODIFIER;
  }
  ...
  public void setCallFunction(boolean newCallFunction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_METHOD_MODIFIER__CALL_FUNCTION, oldCallFunction, callFunction));
  }
  ...
  public void setCallUpdate(boolean newCallUpdate)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_METHOD_MODIFIER__CALL_UPDATE, oldCallUpdate, callUpdate));
  }
  ...
  public void setCallQuery(boolean newCallQuery)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_METHOD_MODIFIER__CALL_QUERY, oldCallQuery, callQuery));
  }
  ...
  public void setCallQueryFunction(boolean newCallQueryFunction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_METHOD_MODIFIER__CALL_QUERY_FUNCTION, oldCallQueryFunction, callQueryFunction));
  }
  ...
  public void setCallSelectFunction(boolean newCallSelectFunction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessorMetaPackage.POJO_METHOD_MODIFIER__CALL_SELECT_FUNCTION, oldCallSelectFunction, callSelectFunction));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessorMetaPackage.POJO_METHOD_MODIFIER__CALL_FUNCTION:
        return isCallFunction();
      case ProcessorMetaPackage.POJO_METHOD_MODIFIER__CALL_UPDATE:
        return isCallUpdate();
      case ProcessorMetaPackage.POJO_METHOD_MODIFIER__CALL_QUERY:
        return isCallQuery();
      case ProcessorMetaPackage.POJO_METHOD_MODIFIER__CALL_QUERY_FUNCTION:
        return isCallQueryFunction();
      case ProcessorMetaPackage.POJO_METHOD_MODIFIER__CALL_SELECT_FUNCTION:
