 ...
 * <ul>
 *   <li>{@link org.sqlproc.meta.processorMeta.Extends#getExtends <em>Extends</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.Extends#isGenerics <em>Generics</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.Extends#getOnlyPojos <em>Only Pojos</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.Extends#getOnlyDaos <em>Only Daos</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.Extends#getExceptPojos <em>Except Pojos</em>}</li>
 *   <li>{@link org.sqlproc.meta.processorMeta.Extends#getExceptDaos <em>Except Daos</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getExtends()
 * @model
 * @generated
 */
public interface Extends extends AbstractPojoEntity
{
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getExtends_Extends()
   * @model
   * @generated
   */
  JvmType getExtends();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.Extends#getExtends <em>Extends</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getExtends_Generics()
   * @model
   * @generated
   */
  boolean isGenerics();
  ...
  /**
   * Sets the value of the '{@link org.sqlproc.meta.processorMeta.Extends#isGenerics <em>Generics</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getExtends_OnlyPojos()
   * @model
   * @generated
   */
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getExtends_OnlyDaos()
   * @model
   * @generated
   */
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getExtends_ExceptPojos()
   * @model
   * @generated
   */
   ...
   * @see org.sqlproc.meta.processorMeta.ProcessorMetaPackage#getExtends_ExceptDaos()
   * @model
   * @generated
   */
