...
(
    ...
    { 
    newLeafNode(this_WS_12, grammarAccess.getPropertyAccess().getWSTerminalRuleCall_1_6_1()); 
    }
)+(
(
		lv_replaceId_13_0=RULE_IDENT
		{
			newLeafNode(lv_replaceId_13_0, grammarAccess.getPropertyAccess().getReplaceIdIDENTTerminalRuleCall_1_6_2_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getPropertyRule());
    ...
    { 
    newLeafNode(this_WS_14, grammarAccess.getPropertyAccess().getWSTerminalRuleCall_1_6_3()); 
    }
)+(
(
		{ 
    ...
    |((
(
		lv_name_16_0=	'replace-all-replacement' 
    {
        newLeafNode(lv_name_16_0, grammarAccess.getPropertyAccess().getNameReplaceAllReplacementKeyword_1_7_0_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "name", lv_name_16_0, "replace-all-replacement");
	    }

)
)(this_WS_17=RULE_WS
    { 
    newLeafNode(this_WS_17, grammarAccess.getPropertyAccess().getWSTerminalRuleCall_1_7_1()); 
    }
)+(
(
		lv_replaceId_18_0=RULE_IDENT
		{
			newLeafNode(lv_replaceId_18_0, grammarAccess.getPropertyAccess().getReplaceIdIDENTTerminalRuleCall_1_7_2_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getPropertyRule());
    ...
    { 
    newLeafNode(this_WS_19, grammarAccess.getPropertyAccess().getWSTerminalRuleCall_1_7_3()); 
    }
)+(
(
		{ 
		...
		lv_replacement_20_0=ruleValueType		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getPropertyRule());
	        }
       		set(
    ...
    |(
(
		lv_name_21_0=	'compress-meta-directives' 
    {
        newLeafNode(lv_name_21_0, grammarAccess.getPropertyAccess().getNameCompressMetaDirectivesKeyword_1_8_0());
    }
 
	    {
	        if ($current==null) {
       		...
       		setWithLastConsumed($current, "name", lv_name_21_0, "compress-meta-directives");
	    }

)
))this_SEMICOLON_22=RULE_SEMICOLON
    { 
    newLeafNode(this_SEMICOLON_22, grammarAccess.getPropertyAccess().getSEMICOLONTerminalRuleCall_2()); 
    }
)
;
