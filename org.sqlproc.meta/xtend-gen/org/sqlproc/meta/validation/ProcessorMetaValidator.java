...
public class ProcessorMetaValidator extends AbstractProcessorMetaValidator {
  ...
  public void checkDatabaseColumn(final DatabaseColumn databaseColumn) {
    ...
    if (_notEquals) {
      IScope _scope = this.scopeProvider.getScope(artifacts, ProcessorMetaPackage.Literals.ARTIFACTS__TABLES);
  ...
  public void checkDatabaseTable(final DatabaseTable databaseTable) {
    ...
    final Function1<String, TableDefinition> _function = new Function1<String, TableDefinition>() {
      public TableDefinition apply(final String value) {
        IScope _scope = ProcessorMetaValidator.this.scopeProvider.getScope(artifacts, ProcessorMetaPackage.Literals.ARTIFACTS__TABLES);
        return Utils.findTable(ProcessorMetaValidator.this.qualifiedNameConverter, artifacts, _scope, value);
      }
    };
